...
similarityFunction1[name_, post_ : Identity][graph_, vs : (_List|All)] :=
    catch@Block[{ig = igMakeUnweighted[graph]},
      post@check@ig@name[ vss[graph][vs] ]
    ]
...
similarityFunction2[name_][graph_, vs : (_List|All), loops_] :=
    catch@Block[{ig = igMakeUnweighted[graph]},
      check@ig@name[vss[graph][vs], loops ]
    ]
